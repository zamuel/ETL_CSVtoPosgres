...
# Paths
# Path here we are located
base_path = os.path.abspath(__file__ + "/../../")
# This the URL Source can be  API
source_url = "https://assets.datacamp.com/production/repositories/5899/datasets/3050e5d21f229317011a051d138857383823696f/PPR-2021.zip"
# This is where the zip is going to download zip
...
def save_new_raw_data():
    ...
    with ZipFile(source_path, mode="r") as zipfile:
        ...
        with open(csv_file_path, mode="r") as csv_file:
            ...
            with open(csv_file_path, mode="w", encoding="windows-1252", ) as csv_file:
