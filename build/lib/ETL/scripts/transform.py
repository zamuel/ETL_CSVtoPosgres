...
from ETL.scripts.common.tables import PprRawAll
from ETL.scripts.common.base import session
...
raw_path = f"{base_path}/data/raw/downloaded_at=2021-02-01/ppr-all.csv/ppr-2021.csv"
